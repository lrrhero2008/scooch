...
The basic bellows control with default styling.
...
The basic bellows control with images to reveal when a header is expanded or collapsed.

<ul class="m-bellows m-indicators-images">
    <li class="m-item">
        <h3 class="m-header">
            <a>Portland</a>
        </h3>
...
The basic bellows control with +/- CSS indicators that reveal when a header is expanded or collapsed.

<ul class="m-bellows m-indicators-css">
    <li class="m-item">
        <h3 class="m-header">
            <a>8-bit</a>
        </h3>
...
<ul class="m-bellows m-indicators-css m-css-advanced">
    <li class="m-item">
        <h3 class="m-header">
            <a>Kale Chips</a>
        </h3>
...
The basic bellows control with CSS arrows to indicate open headers.

<ul class="m-bellows m-arrows">
    <li class="m-item">
        <h3 class="m-header">
            <a>Food Trucks</a>
        </h3>
